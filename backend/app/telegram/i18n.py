...
MESSAGES: dict[str, dict[str, str]] = {
    "it": {
        ...
        "start": (
            ...
            "  /tool on|off — attiva/disattiva l'uso degli strumenti\n"
            "  /tools — elenca gli strumenti e gli MCP disponibili\n"
    ...
    "en": {
        ...
        "start": (
            ...
            "  /tool on|off — enable/disable tool usage\n"
            "  /tools — list the available tools and MCP servers\n"
    ...
    "fr": {
        ...
        "start": (
            ...
            "  /tool on|off — activer/désactiver l'usage des outils\n"
            "  /tools — lister les outils et serveurs MCP disponibles\n"
    ...
    "de": {
        ...
        "start": (
            ...
            "  /tool on|off — Tool-Nutzung aktivieren/deaktivieren\n"
            "  /tools — verfügbare Tools und MCP-Server auflisten\n"
    ...
    "es": {
        ...
        "start": (
            ...
            "  /tool on|off — activar/desactivar el uso de herramientas\n"
            "  /tools — listar las herramientas y servidores MCP disponibles\n"
